...
export const PROJECTS: Project[] = [
    {
        ...
        goal: "Design and build a clean, professional personal portfolio that clearly communicates my experience as a full-stack developer, while remaining fast, maintainable, and visually minimal. Beyond showcasing projects, the site reflects my approach to software development: clarity, structure, and thoughtful details over visual noise.",
        challenge:
    ...
    },
    {
        ...
        techStack: [
            ...
            },
            {
                ...
                technologies: ["QuickBooks API", "REST API"],
            },
        ],
        designDecisions: [
    ...
    },
    {
        ...
        shortDescription:
            "A real-time locating system (RTLS) prototype combining embedded firmware, wireless communication, and a web-based visualization platform to track the position of electronic devices with high accuracy.",
        goal: "Design and validate a real-time positioning system capable of tracking mobile devices inside an indoor environment, combining embedded electronics, positioning algorithms, and a web-based visualization interface.",
        challenge:
            "Achieving reliable positioning accuracy in an indoor environment while integrating firmware, data transmission, and real-time visualization into a cohesive system suitable for future commercial development.",
        roleDescription:
        ...
        techStack: [
            ...
            {
                category: "Backend",
                technologies: ["Node.js", "PHP", "MySQL", "REST API"],
            },
        ],
        designDecisions: [
    ...
    },
    {
        ...
        shortDescription:
            "A prototype IoT solution to estimate water level in 20L containers using capacitive sensing, featuring a custom firmware algorithm and an API integration layer to store and expose measurements to a companion Android app.",
        goal: "Build a reliable prototype capable of estimating the liquid level in water containers using capacitive sensing, and deliver those readings to a backend service that could be consumed by a mobile application.",
        challenge:
            "Translating raw sensor readings into a stable and meaningful 'water level' value under real-world conditions. This required careful handling of noise, calibration behavior, and ensuring consistent measurements over time, while keeping the firmware lightweight and reliable.",
        roleDescription:
    ...
    },
    {
        ...
        shortDescription:
            "A distributed advertising platform that connects a web-based management system with physical vending machines, enabling video ad synchronization, real-time interaction tracking, and usage statistics per video and publisher.",
        goal: "Build an end-to-end advertising platform that allows agencies and publishers to upload and manage video advertisements, synchronize content with vending machines in the field, and track real-world interactions generated by users. The system needed to bridge a web application with embedded devices while keeping data accurate and operationally manageable.",
        challenge:
            "Designing a reliable communication flow between the web platform and physical machines operating under real-world network constraints. This included synchronizing video files over WiFi, tracking user interactions through hardware events, and keeping consistent counts per video, machine, and publisher to generate trustworthy statistics.",
        roleDescription:
        ...
        techStack: [
            ...
            },
            {
                ...
                technologies: ["Raspberry Pi", "WiFi"],
            },
        ],
        designDecisions: [
    ...
    },
    {
        ...
        shortDescription:
            "A corporate informational website built for an engineering and hardware development company, designed to clearly communicate services, capabilities, and development processes through a structured and professional interface.",
        goal: "Design and develop an informational website for B-Circuits that clearly presents the company's engineering services, development process, and value proposition. The site needed to communicate technical credibility while remaining accessible to potential clients from non-technical backgrounds.",
        challenge:
            "Translating complex engineering and hardware development services into clear, well-structured content that could be easily understood by prospective clients, without oversimplifying the technical depth of the company's work.",
        roleDescription:
        ...
        whatIBuilt: [
            ...
            "Implemented a responsive frontend layout using Bootstrap and React.",
    ...
    },
    {
        ...
        technologies: ["C++", "ESP8266", "IoT", "REST API", "MySQL", "WiFi"],
        year: 2018,
        ...
        shortDescription:
            "An IoT monitoring prototype that measures room temperature and humidity, displays readings on an onboard LCD, and sends time-series measurements to a REST API for storage in MySQL and visualization in an existing web dashboard.",
        goal: "Implement the firmware and connectivity layer for an embedded monitoring device that captures temperature and humidity readings, shows them locally on an LCD, and reliably uploads the measurements to the client's backend for historical tracking and visualization.",
        challenge:
            "Ensuring consistent measurements and dependable delivery over WiFi to the backend API, while keeping the firmware stable and lightweight. Additionally, integration required aligning the device payloads with an existing web platform and database schema so the client could visualize the data without changing their dashboard workflow.",
        roleDescription:
    ...
    },
    {
        ...
        techStack: [
            ...
            {
                category: "Integrations",
                technologies: ["USPS API", "CardPointe"],
            },
        ],
        designDecisions: [
    ...
    },
    {
        ...
        techStack: [
            ...
            {
                category: "Backend",
                technologies: ["PHP", "Node.js", "Yii Framework", "REST API"],
            },
            {
                category: "Database",
                technologies: ["MySQL"],
    ...
    },
    {
        ...
        goal: "Design and develop a professional informational website that clearly presents BioFractal's vision, methodology, and areas of expertise in sustainable technology. The site needed to communicate credibility, structure, and purpose while remaining accessible to a broad, non-technical audience.",
        challenge:
            "Translating complex, multidisciplinary concepts related to sustainability, technology, and innovation into clear, easy-to-understand content without oversimplifying the message. The site also needed to maintain a strong institutional identity while being responsive and performant across devices.",
        roleDescription:
        ...
        whatIBuilt: [
            "Developed a responsive, informative website using React for the frontend.",
        ...
        techStack: [
            {
                category: "Frontend",
                technologies: ["React", "Redux", "Bootstrap", "HTML", "CSS"],
            },
            {
                category: "Backend",
    ...
    },
    {
        ...
        badges: ["Android", "Java", "REST API", "Mobile App", "Team Project"],
    },
    {
        ...
        technologies: ["WordPress", "HTML", "CSS", "PHP", "Responsive Design"],
        year: 2015,
